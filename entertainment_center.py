...
american_president = media.Movie("The American President",
								"Comedy-drama about a widowed U.S. president and a lobbist who fall in love.",
								"https://upload.wikimedia.org/wikipedia/en/f/f2/The_American_President_%28movie_poster%29.jpg",
...
red_octrober = media.Movie("The Hunt for Red October",
							"In November 1984, the Soviet Union's best submarine captain in their newest sub violates orders and heads for the USA.",
...
blazing_saddles = media.Movie("Blazing Saddles",
							"To ruin a western town, a corrupt political boss appoints a black sheriff, who promplty becomes his most formidable adversary.",
...
movies = [oceans_11, american_president, princess_bride, shawshank_redemption, red_octrober, blazing_saddles]
